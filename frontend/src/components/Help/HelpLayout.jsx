  ...
  return (
    <div>
      <section id="services-box">
        <h1 className="servHeader">
          Find your perfect pet sitter on{" "}
          <span className="mlSpan">Mil Leches</span>
        </h1>
        <div className="servicesCards">
          <div className="findSitter">
            ...
            <p className="servDesc">
              Use the search bar in your profile to locate all the available pet
              sitters on your preferred island.
            </p>
          </div>
